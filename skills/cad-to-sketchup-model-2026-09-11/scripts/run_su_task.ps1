...
$LoaderSource = Join-Path $Workspace "su_task_loader.rb"
$LoaderDest = Join-Path $PluginDir "codex_su_task_loader.rb"
$LoaderDisabled = "$LoaderDest.disabled"
$ConfigDest = Join-Path $PluginDir "codex_su_task_config.json"
