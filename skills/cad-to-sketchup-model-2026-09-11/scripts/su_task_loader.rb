...
module CodexSuTaskLoader
  extend self

  CONFIG_PATH = File.join(__dir__, 'codex_su_task_config.json')
  FALLBACK_LOG_PATH = File.join(__dir__, 'codex_su_task_loader_fallback.log')
  ...
  def run_task
    ...
    raise 'Missing task_script in codex_su_task_config.json' if task_script.empty?
