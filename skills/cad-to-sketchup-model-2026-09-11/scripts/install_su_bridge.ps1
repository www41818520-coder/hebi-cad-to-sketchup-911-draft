...
$BridgeSource = Join-Path $Workspace "su_codex_bridge.rb"
$BridgeDest = Join-Path $PluginDir "su_codex_bridge.rb"
$ConfigDest = Join-Path $PluginDir "codex_su_bridge_config.json"
